  ...
  return (
    <>
      ...
      <div className='bg-gray-800 relative min-h-screen min-w-screen flex flex-col pb-[300px] pr-1 justify-center overflow-hidden'>
        ...
        <div className=' text-white font-semibold ml-auto mr-auto text-2xl min-w-[20px] max-w-[900px] min-h-[50px] py-3 px-4 rounded-[20px] relative left-[-10px] top-[350px] mb-12 justify-evenly'>
          {/* // */}
